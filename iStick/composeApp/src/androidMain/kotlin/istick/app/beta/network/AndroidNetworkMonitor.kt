// File: iStick/composeApp/src/androidMain/kotlin/istick/app/beta/network/AndroidNetworkMonitor.kt
...
actual fun createNetworkMonitor(): NetworkMonitor {
    // Note: This will throw an exception if context is not available
    // In a real implementation, you'd pass context from the application
    throw IllegalStateException("Context must be provided for Android NetworkMonitor")
}
